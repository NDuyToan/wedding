...
export default function HeroSection() {
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 text-center text-white">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-b from-black/25 via-[#3b2028]/20 to-black/55" />
      ...
      >
        <p className="mb-5 text-xs font-medium uppercase tracking-[0.6em] text-rose-100 md:text-sm">
          Thiệp Mời Cưới
        </p>
        ...
        <p className="mx-auto mb-8 max-w-2xl text-lg font-light tracking-[0.22em] text-rose-50 md:text-2xl">
